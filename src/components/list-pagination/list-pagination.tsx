import { Component, ComponentInterface, ComponentWillLoad, EventEmitter, Event, h, Host, Prop, State } from '@stencil/core';
    ...
    return (
      <Host>
        <ul>
          ...
          {this.previousPage && <li onClick={() => this.handleClick(this.offset - this.itemsPerPage)}>{this.previousPage}</li>}

          <li class="current">{this.currentPage}</li>

          {this.nextPage && <li onClick={() => this.handleClick(this.offset + this.itemsPerPage)}>{this.nextPage}</li>}
